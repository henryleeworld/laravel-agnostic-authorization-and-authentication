...
class User extends Model implements Authenticatable, CanResetPassword, PermissibleInterface, PersistableInterface, RoleableInterface, UserInterface
{
    use AuthenticableTrait, Notifiable, PermissibleTrait;
